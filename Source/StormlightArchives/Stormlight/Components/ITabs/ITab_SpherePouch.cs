...
namespace StormlightMod {
    public class ITab_SpherePouch : ITab {
        ...
        private CompSpherePouch PouchSpheres {
            get {
                return SelPawn.apparel?.WornApparel.Select(a => a.GetComp<CompSpherePouch>()).FirstOrDefault(comp => comp != null);
            }
        }
        ...
        protected override void FillTab() {
            ...
            for (int i = 0; i < pouchContents.Count; i++) {
                ...
                if (Mouse.IsOver(rowRect)) {
                    ...
                    if (comp != null) {
                        ...
                        Widgets.Label(new Rect(tooltipRect.x + 5f, tooltipRect.y + 5f, tooltipRect.width - 10f, tooltipRect.height - 10f), tooltip);
                    }
                }
            ...
            if (Widgets.ButtonText(addButtonRect, "Add Sphere")) {
                ...
                Thing sphere = GenClosest.ClosestThing_Global(SelPawn.Position, SelPawn.Map.listerThings.ThingsOfDef(matchingSphereDef));
